...
object Ex45 {
    def main(args: Array[String]) {
		...
		// p1 pariaza si p2 pariaza
		val prob1=Apply(player1Bet1, player2Bet,
			(bet11: Boolean, bet2: Boolean) =>
			bet11 && bet2)
		println("PROBABILITATEA 1: ")
		println(VariableElimination.probability(prob1, true))
		
		//p1 pariaza si p2 nu pariaza
		val prob2=Apply(player1Bet1, player2Bet,
			(bet11: Boolean, bet2: Boolean) =>
			bet11 && !bet2)
		println("PROBABILITATEA 2: ")
		println(VariableElimination.probability(prob2, true))
		
		//p1 nu pariaza si p2 pariaza
		val prob3=Apply(player1Bet1, player2Bet,
			(bet11: Boolean, bet2: Boolean) =>
			!bet11 && bet2)
		println("PROBABILITATEA 3: ")
		println(VariableElimination.probability(prob3, true))
